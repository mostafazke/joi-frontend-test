        ...
        (function sliderInit() {
            ...
            if (hasNav) {
                ...
                if (navContainer) {
                    ...
                    for (var i = 0; i < slideCount; i++) {
                        ...
                        navHtml += '<div class="dot" data-nav="' + i + '" aria-selected="false" aria-controls="' + slideItems[initIndex + i].id + hiddenStr + '"></div>';
                    }
            ...
            if (hasControls) {
                if (controlsContainer) {
                    ...
                    outerWrapper.insertAdjacentHTML('afterbegin', '<div class="tns-controls" aria-label="Carousel Navigation"><div data-controls="next" class="next" aria-controls="' + slideId + '"></div><div data-controls="prev" class="prev" aria-controls="' + slideId + '"></div></div>');
        ...
        function onTouchOrMouseStart(e) {
            if (!running) {
                ...
                if (isTouchEvent(e)) {
                    ...
                    ev = e;
                    if (['img', 'a'].indexOf(getLowerCaseNodeName(getTarget(ev))) >= 0) {
